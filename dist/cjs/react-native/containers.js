...
exports.useSelectionOwnersStore =
  exports.useIsResolvedGrabSelectionOwner =
  exports.useResolvedGrabSelectionOwnerId =
  exports.getResolvedGrabSelectionOwnerId =
  exports.getResolvedGrabSelectionOwner =
  exports.getGrabSelectionOwner =
  exports.clearGrabSelectionOwnerFocus =
  exports.setGrabSelectionOwnerFocused =
  exports.unregisterGrabSelectionOwner =
  exports.registerGrabSelectionOwner =
...
const useResolvedGrabSelectionOwnerId = () => {
  return (0, react_1.useSyncExternalStore)(
    subscribe,
    () => (0, exports.getResolvedGrabSelectionOwnerId)(),
    () => null,
  );
};
...
const useIsResolvedGrabSelectionOwner = (id) => {
  return (0, react_1.useSyncExternalStore)(
    subscribe,
    () => (0, exports.getResolvedGrabSelectionOwnerId)() === id,
    () => false,
  );
};
