...
const ContextMenu = ({ anchor, bounds = null, children, cutout = null, dismissOnOutsidePress = true, horizontalAlignment = "center", offset = { x: 0, y: 10 }, onClose, verticalAlignment = "top", visible, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { pointerEvents: "box-none", style: styles.overlay, children: [dismissOnOutsidePress &&
                dismissalRegions.map((region) => ((0, jsx_runtime_1.jsx)(react_native_1.Pressable, { accessibilityLabel: "Close context menu", onPress: onClose, style: region.style }, `pressable-${region.key}`))), (0, jsx_runtime_1.jsx)(ContextMenuContext.Provider, { value: { onClose }, children: (0, jsx_runtime_1.jsx)(react_native_1.Animated.View, { onLayout: handleLayout, style: [
                        styles.menu,
                        position,
                        {
                            opacity: animation,
