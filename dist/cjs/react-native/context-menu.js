...
const getMenuPosition = (
  ...
  const { width: screenWidth, height: screenHeight } =
    bounds ?? react_native_1.Dimensions.get("window");
...
const ContextMenu = ({
  ...
  const renderedItems = (0, react_1.useMemo)(
    () => react_1.Children.toArray(children).filter((child) => (0, react_1.isValidElement)(child)),
    [children],
  );
  ...
  return (0, jsx_runtime_1.jsxs)(react_native_1.View, {
    ...
    children: [
      ...
      (0, jsx_runtime_1.jsx)(ContextMenuContext.Provider, {
        value: { onClose },
