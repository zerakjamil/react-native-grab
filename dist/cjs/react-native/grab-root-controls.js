...
const ReactNativeGrabRootControls = () => {
  ...
  const controlBarPosition = (0, react_1.useRef)(
    new react_native_1.Animated.ValueXY(INITIAL_BAR_POSITION),
  ).current;
  ...
  const dragHandlePanResponder = (0, react_1.useRef)(
  ...
  return (0, jsx_runtime_1.jsx)(full_screen_overlay_1.FullScreenOverlay, {
    children: (0, jsx_runtime_1.jsx)(react_native_1.View, {
      pointerEvents: "box-none",
      style: styles.overlayRoot,
      children: (0, jsx_runtime_1.jsx)(grab_control_bar_1.GrabControlBar, {
        ...
        onPressFreeze: grab_controller_1.toggleGrabFreeze,
        onPressHide: toggleMenuVisibility,
        onPressSelect: grab_controller_1.enableGrabbing,
      }),
    }),
  });
};
