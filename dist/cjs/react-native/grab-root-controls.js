...
const ReactNativeGrabRootControls = () => {
    ...
    return ((0, jsx_runtime_1.jsx)(full_screen_overlay_1.FullScreenOverlay, { children: (0, jsx_runtime_1.jsx)(react_native_1.View, { pointerEvents: "box-none", style: styles.overlayRoot, children: (0, jsx_runtime_1.jsx)(grab_control_bar_1.GrabControlBar, { containerStyle: containerStyle, dragHandlePanHandlers: dragHandlePanResponder.panHandlers, isFreezeActive: state.freeze.isActive, isFreezeCapturing: state.freeze.isCapturing, isSessionEnabled: state.selectionSessionOwnerId !== null, isVisible: isControlBarVisible, onHidden: resetControlBarPosition, onPressFreeze: grab_controller_1.toggleGrabFreeze, onPressHide: toggleMenuVisibility, onPressSelect: grab_controller_1.enableGrabbing }) }) }));
};
