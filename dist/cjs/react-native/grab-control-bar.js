...
const GrabControlBar = ({
  ...
  const visibilityProgress = (0, react_1.useRef)(
    new react_native_1.Animated.Value(isVisible ? 1 : 0),
  ).current;
  (0, react_1.useEffect)(() => {
    if (isVisible) {
      setIsRendered(true);
  ...
  return (0, jsx_runtime_1.jsx)(react_native_1.Animated.View, {
    ...
    children: (0, jsx_runtime_1.jsx)(react_native_1.Animated.View, {
      ...
      children: (0, jsx_runtime_1.jsx)(react_native_1.Animated.View, {
        ...
        children: (0, jsx_runtime_1.jsxs)(react_native_1.View, {
          ...
          children: [
            ...
            (0, jsx_runtime_1.jsx)(react_native_1.View, { style: styles.divider }),
