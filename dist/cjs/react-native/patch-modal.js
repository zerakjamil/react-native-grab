  ...
  try {
    ...
    const PatchedModal = react_1.default.forwardRef((props, ref) => {
      return react_1.default.createElement(
        OriginalModal,
        { ...props, ref },
        react_1.default.createElement(ReactNativeGrabModal, { style: { flex: 1 } }, props.children),
      );
    });
    ...
    const origCreateElement = react_1.default.createElement.bind(react_1.default);
    react_1.default.createElement = function patchedCreateElement(type, config, ...children) {
      if (type === OriginalModal) {
        const grabWrapped = origCreateElement(
