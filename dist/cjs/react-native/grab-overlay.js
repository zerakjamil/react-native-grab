...
const ReactNativeGrabOverlay = ({ ownerId, onPanHandlersChange }) => {
  ...
  const getElementAtPoint = (0, react_1.useCallback)(
    (pageX, pageY) => {
  ...
  const handleGrabbing = (0, react_1.useCallback)(
    async (result) => {
  ...
  const handleCopyElementPath = (0, react_1.useCallback)(async () => {
    ...
    const label = (0, props_1.buildComponentPathLabel)(
  ...
  return (0, jsx_runtime_1.jsxs)(react_native_1.View, {
    ...
    children: [
      freezeState.isActive &&
        freezeState.snapshot?.uri &&
        (0, jsx_runtime_1.jsx)(react_native_1.View, {
          pointerEvents: "none",
          style: styles.freezeImageWrap,
      ...
      showLayoutMetrics &&
        ...
        (0, jsx_runtime_1.jsx)(react_native_1.View, {
          ...
          children: (0, jsx_runtime_1.jsx)(react_native_1.Text, {
            ...
            children: `x:${layoutMetrics.x} y:${layoutMetrics.y} w:${layoutMetrics.width} h:${layoutMetrics.height}`,
          }),
        }),
      (0, jsx_runtime_1.jsxs)(context_menu_1.ContextMenu, {
        anchor: selectedElementMenuAnchor,
        bounds: bounds,
        cutout: state.selectedElement
          ? {
        ...
        children: [
          (0, jsx_runtime_1.jsx)(react_native_1.View, {
            style: styles.selectionMenuHeader,
            children: (0, jsx_runtime_1.jsx)(react_native_1.Text, {
              adjustsFontSizeToFit: true,
              minimumFontScale: 0.65,
              numberOfLines: 1,
              style: styles.selectionMenuTitle,
              children: state.selectedElement?.elementName,
            }),
          }),
          (0, jsx_runtime_1.jsx)(context_menu_1.ContextMenu.Item, {
            onPress: () => void handleCopySelectedElement(),
            children: "Copy summary",
          }),
          (0, jsx_runtime_1.jsx)(context_menu_1.ContextMenu.Item, {
            onPress: () => void handleCopyElementPath(),
            children: "Copy name + path",
          }),
          (0, jsx_runtime_1.jsx)(context_menu_1.ContextMenu.Item, {
            onPress: () => void handleCopyProps(),
            children: "Copy props JSON",
          }),
          (0, jsx_runtime_1.jsx)(context_menu_1.ContextMenu.Item, {
            onPress: handleToggleLayoutMetrics,
            children: showLayoutMetrics ? "Hide layout metrics" : "Show layout metrics",
          }),
          (0, jsx_runtime_1.jsx)(context_menu_1.ContextMenu.Item, {
