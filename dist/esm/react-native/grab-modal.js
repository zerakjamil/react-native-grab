...
export const ReactNativeGrabModal = ({ children, style, id, isActive = true, ...props }) => {
    ...
    return (_jsxs(View, { ...props, ...(panHandlers ?? {}), collapsable: false, ref: modalRef, style: [{ flex: 1 }, style], children: [children, _jsx(ReactNativeGrabOverlay, { ownerId: ownerIdRef.current, onPanHandlersChange: setPanHandlers })] }));
};
