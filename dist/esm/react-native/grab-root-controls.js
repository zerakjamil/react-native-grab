...
import { enableGrabbing, toggleGrabFreeze, toggleGrabMenu, useGrabControllerState, } from "./grab-controller";
...
export const ReactNativeGrabRootControls = () => {
    ...
    const isControlBarVisible = state.isMenuVisible &&
    ...
    return (_jsx(FullScreenOverlay, { children: _jsx(View, { pointerEvents: "box-none", style: styles.overlayRoot, children: _jsx(GrabControlBar, { containerStyle: containerStyle, dragHandlePanHandlers: dragHandlePanResponder.panHandlers, isFreezeActive: state.freeze.isActive, isFreezeCapturing: state.freeze.isCapturing, isSessionEnabled: state.selectionSessionOwnerId !== null, isVisible: isControlBarVisible, onHidden: resetControlBarPosition, onPressFreeze: toggleGrabFreeze, onPressHide: toggleMenuVisibility, onPressSelect: enableGrabbing }) }) }));
};
