...
export const ContextMenu = ({ anchor, bounds = null, children, cutout = null, dismissOnOutsidePress = true, horizontalAlignment = "center", offset = { x: 0, y: 10 }, onClose, verticalAlignment = "top", visible, }) => {
    ...
    return (_jsxs(View, { pointerEvents: "box-none", style: styles.overlay, children: [dismissOnOutsidePress &&
                dismissalRegions.map((region) => (_jsx(Pressable, { accessibilityLabel: "Close context menu", onPress: onClose, style: region.style }, `pressable-${region.key}`))), _jsx(ContextMenuContext.Provider, { value: { onClose }, children: _jsx(Animated.View, { onLayout: handleLayout, style: [
                        styles.menu,
                        position,
                        {
                            opacity: animation,
