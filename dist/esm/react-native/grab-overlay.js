    ...
    children: [
      ...
      state.isCopyBadgeVisible &&
        _jsx(View, {
          pointerEvents: "none",
          style: styles.topBadge,
          children: _jsx(Text, { style: styles.topBadgeText, children: "Element copied" }),
        }),
      !!highlightedElement &&
        _jsx(View, {
          pointerEvents: "none",
          ...
          _jsxs(View, {
            ...
            children: [
              _jsx(Pressable, {
                ...
                children: _jsx(Text, { style: styles.selectionMenuActionText, children: "Copy" }),
              }),
              _jsx(View, { style: styles.selectionMenuActionDivider }),
              _jsx(Pressable, {
                accessibilityRole: "button",
