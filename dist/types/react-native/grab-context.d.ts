...
export declare const composeGrabContextValue: (
  parentValue: InternalReactNativeGrabContextValue,
  value: ReactNativeGrabContextValue,
) => ReactNativeGrabContextValue;
export declare const ReactNativeGrabContextProvider: ({
  value,
  children,
}: ReactNativeGrabContextProviderProps) => import("react/jsx-runtime").JSX.Element;
export {};
